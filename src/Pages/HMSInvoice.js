...
const HMSInvoice = () => {
  ...
  const generatePDF = (count) => {
    ...
    pdf.text(`${formData.no1Rate}`, 126, 78,'right');
    ...
    pdf.text(`${formData.no2Rate}`, 126, 85,'right');
    ...
    pdf.text(`${formData.no3Rate}`, 126, 92,'right');
    ...
    pdf.text(`${formData.no4Rate}`, 126, 99,'right');
    ...
    pdf.text(`${formData.no5Rate}`, 126, 106,'right');
    ...
    pdf.text(`${formData.no6Rate}`, 126, 113,'right');
    ...
    pdf.text(`${formData.no7Rate}`, 126, 120,'right');
    ...
    pdf.text(`${formData.no8Rate}`, 126, 127,'right');
    ...
    pdf.text(`${formData.no9Rate}`, 126, 134,'right');
    ...
    pdf.text(`${formData.no10Rate}`, 126, 141,'right');
    ...
    pdf.text(`${formData.no11Rate}`, 126, 148,'right');
    ...
    pdf.text(`${formData.no12Rate}`, 126, 155,'right');
    ...
    pdf.text(`${formData.no13Rate}`, 126, 162,'right');
    ...
    pdf.text(`${formData.no14Rate}`, 126, 169,'right');
    ...
    pdf.text(`${formData.no15Rate}`, 126, 176,'right');
    ...
    pdf.text(`${formData.no16Rate}`, 126, 183,'right');
    ...
    pdf.text(`${formData.no17Rate}`, 126, 190,'right');
    ...
    pdf.text(`${formData.no18Rate}`, 126, 197,'right');
    ...
    pdf.text(`${formData.no19Rate}`, 126, 204,'right');
    ...
    pdf.text(`${formData.no20Rate}`, 126, 211,'right');
